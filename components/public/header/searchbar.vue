    ...
    <el-row class="m-header-searchbar">
      ...
      <el-col :span="15" class="center">
        ...
        <ul class="nav">
          ...
          <li><nuxt-link to="/" class="takeout">猫眼电影</nuxt-link></li>
          <li><nuxt-link to="/" class="takeout">美团酒店</nuxt-link></li>
          <li><nuxt-link to="/" class="takeout">民宿/公寓</nuxt-link></li>
          <li><nuxt-link to="/" class="takeout">商家入驻</nuxt-link></li>
        </ul>
      </el-col>
